...
import { Globe, ArrowRight, Waves, Sun, Moon } from "@phosphor-icons/react";
...
const TitleOverlay = styled.div<{ $visible: boolean }>`
  ...
  @media (max-width: 700px) { top: 60px; }
`;
...
const PageTitle = styled.h1`
  ...
  @media (max-width: 700px) { font-size: 2.6rem; }
...
const PageSubtitle = styled.p`
  ...
  margin: 0;
  text-shadow: 0 1px 10px rgba(20, 10, 4, 0.4);
...
const CardsPanel = styled.div<{ $visible: boolean }>`
  ...
  @media (max-width: 700px) { padding: 14px 16px 18px; gap: 12px; }
`;
...
const Card = styled.div`
  ...
  @media (max-width: 480px) { padding: 12px 14px; gap: 12px; }
`;
...
const Tag = styled.span`
  ...
  color: rgba(213, 201, 190, 0.58);
  background: rgba(245, 242, 234, 0.08);
  border-radius: 5px; padding: 2px 7px;
`;

const ArrowBtn = styled.div`
  color: rgba(227, 149, 90, 0.65);
  flex-shrink: 0;
  transition: color 0.2s ease, transform 0.2s ease;
  ${Card}:hover & { color: #e3955a; transform: translateX(3px); }
`;
    ...
    <Container>
      ...
      <CardsPanel $visible={!isDragging}>
        <Card onClick={() => navigate("/projects/planet")}>
          <CardIcon><Globe size={20} weight="duotone" /></CardIcon>
          <CardBody>
            ...
            <TagRow>
              <Tag>Three.js</Tag><Tag>GLSL</Tag><Tag>Astronomy</Tag>
            </TagRow>
          </CardBody>
          <ArrowBtn><ArrowRight size={16} weight="bold" /></ArrowBtn>
        </Card>

        <Card onClick={() => navigate("/projects/waterwheel")}>
          <CardIcon><Waves size={20} weight="duotone" /></CardIcon>
          <CardBody>
            <CardTitle>Waterwheel Mill</CardTitle>
            <CardDesc>
              A stylized 3D mill scene with an animated river, rotating
              waterwheel, day/night cycle, and billowing chimney smoke.
            </CardDesc>
            <TagRow>
              <Tag>Three.js</Tag><Tag>GLSL</Tag><Tag>3D Scene</Tag>
            </TagRow>
          </CardBody>
          <ArrowBtn><ArrowRight size={16} weight="bold" /></ArrowBtn>
        </Card>
